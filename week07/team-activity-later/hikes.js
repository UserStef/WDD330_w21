...
function renderOneHikeFull(hike) {
  ...
  item.innerHTML = ` 
        ...
        <img src="${imgBasePath}${hike.imgSrc}" alt="${hike.imgAlt}" class="image_full">
        <h2>${hike.name}</h2>
        <div>
            <h3>Distance</h3>
            <p>${hike.distance}</p>
        ...
        <div>
            <div class="div-row">
                <h3>Comments</h3> <button id="show_comments_btn" class="mybtn2" data-show-comments="${hike.hikeId}">Show</button>
            </div>
            <div id="commentSection" class="hidden">
                ...
                <form>
                    <div class="centerAll">
                        ...
                        <button id="add-comment-btn" class="mybtn" data-btn="${hike.hikeId}">+</button>
                    </div>
                </form>
            </div>
        </div>
